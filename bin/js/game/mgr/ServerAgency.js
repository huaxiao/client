...
var ServerAgency = (function(){
    ...
    p.rpcBattleResult = function(gameMode,score,task,callbackHdl) {
        NetMgr.getInstance().rpc(RPC.C2S_UploadBattleResult,{battleType:gameMode,score:score,task:task},function(retData){
